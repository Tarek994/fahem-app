...
String allGovernoratesLabel = 'allGovernorates';

class GovernoratesBtmSheet extends StatefulWidget {
  final List<GovernorateModel> extraGovernorates;

  const GovernoratesBtmSheet({
    super.key,
    required this.extraGovernorates,
  });
...
class _GovernoratesBtmSheetState extends State<GovernoratesBtmSheet> {
  ...
  void initState() {
    ...
    governorates.insertAll(0, widget.extraGovernorates);
  }
