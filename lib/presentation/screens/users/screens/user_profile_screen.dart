                    ...
                    child: Stack(
                      children: [
                        ImageWidget(
                          ...
                          color1: userModel.coverImage == null
                              ? ColorsManager.white
                              : null,
                          width: double.infinity,
                      ...
                      children: [
                        if (userModel.phoneNumber != null) ...[
                          CardInfo(
                            ...
                            title: Methods.getText(StringsManager.phoneNumber)
                                .toTitleCase(),
                        ...
                        if (userModel.country != null) ...[
                          CardInfo(
                            ...
                            title: Methods.getText(StringsManager.country)
                                .toTitleCase(),
                            value: MyProviders.appProvider.isEnglish
                                ? userModel.country!.countryNameEn
                                : userModel.country!.countryNameAr,
                        ...
                        if (userModel.birthDate != null) ...[
                          CardInfo(
                            ...
                            value: Methods.formatDate(
                                milliseconds: int.parse(userModel.birthDate!),
                                format: 'd MMMM yyyy'),
                          ),
                          const SizedBox(height: SizeManager.s10),
                        ],
                        ...
                        CardInfo(
                          ...
                          title: Methods.getText(StringsManager.joinDate)
                              .toTitleCase(),
                          value: Methods.formatDate(
                              milliseconds: int.parse(userModel.createdAt),
                              format: 'd MMMM yyyy'),
                        ),
                        const SizedBox(height: SizeManager.s10),
                        if (userModel.bio != null) ...[
                          CardInfo(
                            ...
                            title: Methods.getText(StringsManager.bio)
                                .toTitleCase(),
                            value: userModel.bio ??
                                Methods.getText(StringsManager.notFound)
                                    .toTitleCase(),
                          ),
                        ],
                      ],
