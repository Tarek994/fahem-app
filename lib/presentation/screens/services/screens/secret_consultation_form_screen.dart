...
class _SecretConsultationFormScreenState extends State<SecretConsultationFormScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<SecretConsultationFormProvider>(
        builder: (context, secretConsultationFormProvider, _) {
          return CustomFullLoading(
            isShowLoading: secretConsultationFormProvider.isLoading,
            waitForDone: secretConsultationFormProvider.isLoading,
            isShowOpacityBackground: true,
            child: CustomScrollView(
              slivers: [
                const DefaultSliverAppBar(title: StringsManager.secretConsultation),
                SliverPadding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // const SizedBox(height: SizeManager.s20),
                          Text(
                            '${Methods.getText(StringsManager.theSecretConsultation).toCapitalized()} *',
                            style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontWeight: FontWeightManager.bold),
                          ),
                          ...
                          CustomTextFormField(
                            ...
                            maxLines: 10,
                            hintText: '${Methods.getText(StringsManager.descriptionOfTheSecretConsultation).toCapitalized()} (${Methods.getText(StringsManager.detailedAndClearExplanation)})',
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      return index == secretConsultationFormProvider.images.length ? Container(
                                        ...
                                        child: Material(
                                          ...
                                          child: InkWell(
                                            onTap: () async {
                                              ...
                                              if(xFile != null) secretConsultationFormProvider.addInImages(xFile.path);
                                            },
                                            borderRadius: BorderRadius.circular(SizeManager.s15),
                                        ...
                                        child: Stack(
                                          children: [
                                            secretConsultationFormProvider.images[index].startsWith(ConstantsManager.fahemImageFromFile) ? Image.file(
                                              File(secretConsultationFormProvider.images[index]),
                                              width: SizeManager.s100,
                                              height: SizeManager.s100,
                                              fit: BoxFit.cover,
                                            ) : ImageWidget(
                                              image: secretConsultationFormProvider.images[index],
                                            ...
                                            PositionedDirectional(
                                              ...
                                              child: Padding(
                                                ...
                                                child: CustomButton(
                                                  onPressed: () async {
                                                    XFile? xFile = await ImagePicker().pickImage(source: ImageSource.gallery);
                                                    if(xFile != null) secretConsultationFormProvider.editInImages(image: xFile.path, index: index);
                                                  },
                                            ...
                                            PositionedDirectional(
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsets.all(SizeManager.s5),
                                                child: CustomButton(
                                                  onPressed: () async => secretConsultationFormProvider.removeFromImages(index),
                                                  buttonType: ButtonType.icon,
                                    ...
                                    itemCount: secretConsultationFormProvider.images.length + 1,
                                  ),
                                ),
                              ],
                            ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      '${900} ${Methods.getText(StringsManager.egp).toUpperCase()}',
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              if(_formKey.currentState!.validate()) {
                                FocusScope.of(context).unfocus();
                                InsertSecretConsultationParameters parameters = InsertSecretConsultationParameters(
                                ...
                                secretConsultationFormProvider.onPressedSendConsultation(context: context, insertSecretConsultationParameters: parameters);
                              }
                            },
