...
class _WithdrawalRequestsScreenState extends State<WithdrawalRequestsScreen> {
  ...
  void initState() {
    ...
    withdrawalRequestsProvider =
        Provider.of<WithdrawalRequestsProvider>(context, listen: false);
    withdrawalRequestsProvider.addListenerScrollController();
    WidgetsBinding.instance.addPostFrameCallback(
        (_) async => await withdrawalRequestsProvider.fetchData());
  }
  ...
  void _onInsert(WithdrawalRequestModel? withdrawalRequest) {
    if (withdrawalRequest != null) {
      ...
      if (withdrawalRequestsProvider.paginationModel != null)
        withdrawalRequestsProvider.paginationModel!.total++;
    }
  }
    ...
    return Consumer<WithdrawalRequestsProvider>(
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          screenTitle: provider.withdrawalRequestsArgs == null
              ? StringsManager.withdrawalRequests
              : StringsManager.walletHistory,
          searchFilterOrderWidget: SearchFilterOrderWidget(
            hintText: StringsManager.searchByBalance,
            ordersItems: const [
              OrderByType.withdrawalRequestsNewestFirst,
              OrderByType.withdrawalRequestsOldestFirst
            ],
            filtersItems: provider.withdrawalRequestsArgs == null
                ? const [
                    FiltersType.dateOfCreated,
                    FiltersType.withdrawalRequestStatus,
          ...
          totalResults: provider.paginationModel == null
              ? 0
              : provider.paginationModel!.total,
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white,
                    // color: MyProviders
                    //             .authenticationProvider.currentAccount.balance <
                    //         1000
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      borderRadius: BorderRadius.circular(8),
                      onTap: MyProviders.authenticationProvider.currentAccount
                                  .balance <
                              1000
                          ? null
                          : () => Methods.routeTo(
