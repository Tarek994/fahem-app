  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: index % 2 == 0 ? ColorsManager.lightSecondaryColor.withOpacity(0.5) : ColorsManager.lightPrimaryColor.withOpacity(0.5),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              RatingBar(numberOfStars: reviewModel.rating),
              ...
              const Spacer(),
              Text(
                Methods.formatDate(milliseconds: int.parse(reviewModel.createdAt), isDateOnly: true),
                style: Theme.of(context).textTheme.bodySmall,
              ),
            ],
          ),
