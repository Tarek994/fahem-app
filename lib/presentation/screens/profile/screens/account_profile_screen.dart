                ...
                SliverToBoxAdapter(
                  child: Column(
                    children: [
                        ...
                        child: Stack(
                          children: [
                            ImageWidget(
                              ...
                              color1: accountModel.coverImage == null
                                  ? ColorsManager.white
                                  : null,
                              width: double.infinity,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            'GOOD MORNING',
                            style: TextStyle(
                                fontSize: 8, color: ColorsManager.veryDarkBlue),
                          )
                        ],
                      ),
                      SizedBox(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              Methods.routeTo(
                                  context, Routes.editAccountProfileScreen,
                                  arguments:
                                      authenticationProvider.currentAccount);
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors
                                  .white, // Replace with ColorsManager.lightSecondaryColor
                              padding:
                            ...
                            icon: const Icon(Icons.edit,
                                size: 16, color: ColorsManager.veryDarkBlue),
                            label: Text(
                              Methods.getText(StringsManager.editProfile)
                                  .toCapitalized(), // Replace with your localization method
                      ...
                      //         context, Routes.editAccountProfileScreen,
                      //         arguments: authenticationProvider.currentAccount),
                      //     buttonType: ButtonType.postSpacerIcon,
                      //     text: Methods.getText(StringsManager.editProfile)
                      //         .toCapitalized(),
                      //     iconData: Icons.edit,
                      ...
                      // Change Password
                      if (authenticationProvider.currentAccount.signInMethod ==
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              icon: const Icon(Icons.password,
                                  size: 16, color: ColorsManager.veryDarkBlue),
                              label: Text(
                                Methods.getText(StringsManager.changePassword)
                                    .toCapitalized(),
                                style: const TextStyle(
                                    fontSize: 12,
                                    color: ColorsManager.veryDarkBlue),
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              Dialogs.showBottomSheetConfirmation(
                                context: context,
                                message: Methods.getText(StringsManager
                                        .doYouWantToDeleteTheAccount)
                                    .toCapitalized(),
                              ).then((value) async {
                                if (value) {
                                  await MyProviders.authenticationProvider
                            ...
                            icon: const Icon(Icons.delete,
                                size: 16, color: ColorsManager.veryDarkBlue),
                            label: Text(
                              Methods.getText(StringsManager.deleteAccount)
                                  .toCapitalized(),
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: ColorsManager.veryDarkBlue),
                        ...
                        child: Container(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              Dialogs.showBottomSheetConfirmation(
                                context: context,
                                message: Methods.getText(
                                        StringsManager.doYouWantToLogout)
                                    .toCapitalized(),
                              ).then((value) {
                                if (value)
                            ...
                            icon: const Icon(Icons.logout,
                                size: 16, color: ColorsManager.veryDarkBlue),
                            label: Text(
                              Methods.getText(StringsManager.logout)
                                  .toCapitalized(),
                              style: const TextStyle(
                                  fontSize: 12,
                                  color: ColorsManager.veryDarkBlue),
                        ...
                        child: Column(
                          children: [
                            CardInfo(
                              ...
                              title:
                                  Methods.getText(StringsManager.emailAddress)
                                      .toTitleCase(),
                            ...
                            if (accountModel.governorate != null) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.governorate)
                                        .toTitleCase(),
                                value: MyProviders.appProvider.isEnglish
                                    ? accountModel
                                        .governorate!.governorateNameEn
                                    : accountModel
                                        .governorate!.governorateNameAr,
                              ),
                              const SizedBox(height: SizeManager.s10),
                            ],
                            if (accountModel.address != null) ...[
                              CardInfo(
                                icon: FontAwesomeIcons.locationDot,
                                title: Methods.getText(StringsManager.address)
                                    .toTitleCase(),
                            ...
                            if (accountModel.phoneNumber != null) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.phoneNumber)
                                        .toTitleCase(),
                            ...
                            if (accountModel.birthDate != null) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(StringsManager.birthDate)
                                    .toTitleCase(),
                                value: Methods.formatDate(
                                    milliseconds:
                                        int.parse(accountModel.birthDate!),
                                    format: 'd MMMM yyyy'),
                              ),
                              const SizedBox(height: SizeManager.s10),
                            ],
                            if (accountModel.gender != null) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(StringsManager.gender)
                                    .toTitleCase(),
                            ...
                            if (accountModel.jobTitle != null) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(StringsManager.jobTitle)
                                    .toTitleCase(),
                            ...
                            if (accountModel.categories.isNotEmpty) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.categories)
                                        .toTitleCase(),
                                value: accountModel.categories
                                    .map((e) =>
                            ...
                            if (accountModel.services.isNotEmpty) ...[
                              CardInfo(
                                icon: FontAwesomeIcons.layerGroup,
                                title: Methods.getText(
                                        StringsManager.fahemServices)
                                    .toTitleCase(),
                                value: accountModel.services
                                    .map((e) =>
                                        MyProviders.appProvider.isEnglish
                                            ? e.nameEn
                                            : e.nameAr)
                            ...
                            if (accountModel.consultationPrice != null) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(
                                        StringsManager.consultationPrice)
                                    .toTitleCase(),
                                value:
                                    '${accountModel.consultationPrice} ${Methods.getText(StringsManager.egp).toTitleCase()}',
                              ),
                              const SizedBox(height: SizeManager.s10),
                            ],
                            if (accountModel.tasks.isNotEmpty) ...[
                              CardInfo(
                                icon: Icons.task_alt,
                                title: Methods.getText(StringsManager.tasks)
                                    .toTitleCase(),
                                value: accountModel.tasks
                                    .map((e) => e)
                                    .toList()
                                    .join(' - '),
                              ),
                            ...
                            if (accountModel.features.isNotEmpty) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(StringsManager.features)
                                    .toTitleCase(),
                                value: accountModel.features
                                    .map((e) => e)
                                    .toList()
                                    .join(' - '),
                              ),
                            ...
                            CardInfo(
                              icon: FontAwesomeIcons.coins,
                              title:
                                  Methods.getText(StringsManager.accountBalance)
                                      .toTitleCase(),
                              value:
                                  '${accountModel.balance} ${Methods.getText(StringsManager.egp).toTitleCase()}',
                            ),
                            const SizedBox(height: SizeManager.s10),
                            CardInfo(
                              icon: FontAwesomeIcons.gear,
                              title:
                                  Methods.getText(StringsManager.accountStatus)
                                      .toTitleCase(),
                              value: AccountStatus.toText(
                            ...
                            if (accountModel.appointmentBooking.isNotEmpty) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(
                                        StringsManager.bookingPeriods)
                                    .toTitleCase(),
                                value: accountModel.appointmentBooking
                                    .map((e) =>
                                        MyProviders.appProvider.isEnglish
                                            ? e.nameEn
                                            : e.nameAr)
                            ...
                            CardInfo(
                              ...
                              title: Methods.getText(
                                      StringsManager.theAccountIsVerified)
                                  .toTitleCase(),
                              value: Methods.getText(accountModel.isFeatured
                                      ? StringsManager.yes
                                      : StringsManager.no)
                                  .toCapitalized(),
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    Methods.getText(accountModel.isFeatured
                                            ? StringsManager.yes
                                            : StringsManager.no)
                                        .toCapitalized(),
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodySmall!
                                        .copyWith(height: SizeManager.s1_8),
                                  ),
                                  const SizedBox(width: SizeManager.s10),
                                  Icon(
                                    accountModel.isFeatured
                                        ? Icons.check_circle
                                        : FontAwesomeIcons.xmark,
                                    color: accountModel.isFeatured
                                        ? ColorsManager.green
                                        : ColorsManager.red,
                                    size: 18,
                                  ),
                            ...
                            CardInfo(
                              icon: FontAwesomeIcons.calendar,
                              title: Methods.getText(StringsManager.joinDate)
                                  .toTitleCase(),
                              value: Methods.formatDate(
                                  milliseconds:
                                      int.parse(accountModel.createdAt),
                                  format: 'd MMMM yyyy'),
                            ),
                            const SizedBox(height: SizeManager.s10),
                            if (accountModel.bio != null) ...[
                              CardInfo(
                                ...
                                title: Methods.getText(StringsManager.bio)
                                    .toTitleCase(),
                            ...
                            if (accountModel.photoGallery.isNotEmpty) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.photoGallery)
                                        .toTitleCase(),
                                child: Wrap(
                                  spacing: SizeManager.s10,
                                  runSpacing: SizeManager.s10,
                                  children: List.generate(
                                      accountModel.photoGallery.length,
                                      (index) => ImageWidget(
                                            image: accountModel
                                                .photoGallery[index],
                                            imageDirectory: ApiConstants
                                                .accountsGalleryDirectory,
                            ...
                            if (accountModel
                              ...
                              CardInfo(
                                icon: FontAwesomeIcons.images,
                                title: Methods.getText(
                                        StringsManager.proofOfIdentity)
                                    .toTitleCase(),
                                child: Wrap(
                                  spacing: SizeManager.s10,
                                  runSpacing: SizeManager.s10,
                                  children: List.generate(
                                      accountModel.identificationImages.length,
                                      (index) => ImageWidget(
                                            image: accountModel
                                                .identificationImages[index],
                                            imageDirectory: ApiConstants
                                                .accountsIdentificationDirectory,
                                            width: SizeManager.s70,
                                            height: SizeManager.s70,
                                            borderRadius: SizeManager.s10,
                                            isShowFullImageScreen: true,
                            ...
                            if (accountModel.nationalId != null) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.nationalId)
                                        .toTitleCase(),
                                value: accountModel.nationalId,
                              ),
                              const SizedBox(height: SizeManager.s10),
                            ],
                            if (accountModel.nationalImageFrontSide !=
                                null) ...[
                              CardInfo(
                                icon: FontAwesomeIcons.idCard,
                                title: Methods.getText(
                                        StringsManager.nationalImage)
                                    .toTitleCase(),
                                child: ImageWidget(
                            ...
                            if (accountModel.cardNumber != null) ...[
                              CardInfo(
                                ...
                                title:
                                    Methods.getText(StringsManager.cardNumber)
                                        .toTitleCase(),
                            ...
                            if (accountModel.cardImage != null) ...[
                              CardInfo(
                                icon: FontAwesomeIcons.idCardClip,
                                title: Methods.getText(StringsManager.cardImage)
                                    .toTitleCase(),
                                child: ImageWidget(
