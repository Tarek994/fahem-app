...
class InstantConsultationsCommentsProvider with ChangeNotifier {
  ...
  Future<void> fetchData() async {
    ...
    if(instantConsultationsCommentsArgs != null) {
      if(instantConsultationsCommentsArgs!.instantConsultation != null) {
      ...
      if(instantConsultationsCommentsArgs!.account != null) {
        filtersMap.addAll({Filters.account.name: instantConsultationsCommentsArgs!.account!.accountId});
      }
    }
