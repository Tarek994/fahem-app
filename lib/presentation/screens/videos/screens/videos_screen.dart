...
import 'package:fahem_business/presentation/screens/videos/widgets/extra_widget_in_top_videos.dart';
...
import 'package:fahem_business/presentation/screens/videos/widgets/video_list_item.dart';
      ...
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          listItemBuilder: (context, index) => VideoListItem(
            ...
            onEdit: (video) => _onEdit(video),
            onDelete: () => _onDelete(provider.videos[index].videoId),
          ),
