          ...
          child: Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: widget.messageModel.senderId == widget.senderId ? ColorsManager.lightPrimaryColor : ColorsManager.grey300,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Text(
                      Methods.formatDate(milliseconds: int.parse(widget.messageModel.timeStamp), isTimeAndAOnly: true),
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              Flexible(
                child: Text(
                  Methods.getText(StringsManager.thisMessageHasBeenDeleted).toCapitalized(),
