            ...
            child: CustomScrollView(
              ...
              slivers: [
                const DefaultSliverAppBar(
                  ...
                  appBarColor: ColorsManager.veryDarkBlue,
                  pinned: false,
                ),
                SliverPadding(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  color: MyProviders.appProvider.isLight
                                      ? ColorsManager.white
                                      : ColorsManager.veryDarkBlue,
                                  borderRadius:
                                      BorderRadius.circular(SizeManager.s50),
                                ),
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: GestureDetector(
                                        onTap: () async {
                                          ...
                                          if (xFile != null)
                                            provider.changePersonalImage(xFile);
                                        },
                                        child: Container(
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            provider.personalImage == null
                                                ? ConstantsManager.empty
                                                : provider.personalImage.name,
                                            maxLines: 1,
                              ...
                              CustomButton(
                                onPressed: () {
                                  Dialogs.mainCategoriesBottomSheet(
                                          context: context)
                                      .then((mainCategory) {
                                ...
                                text: provider.mainCategory == null
                                    ...
                                    : MyProviders.appProvider.isEnglish
                                        ? provider.mainCategory!.nameEn
                                        : provider.mainCategory!.nameAr,
                                width: double.infinity,
                                buttonColor: ColorsManager.white,
                                borderColor: ColorsManager.grey300,
                                textColor: provider.mainCategory == null
                                    ? ColorsManager.grey
                                    : ColorsManager.black,
                                fontSize: SizeManager.s12,
                                isRequired: provider.isButtonClicked &&
                                    provider.mainCategory == null,
                              ),
                              const SizedBox(height: SizeManager.s20),
                              ...
                              CustomTextFormField(
                                ...
                                labelText:
                                    '${Methods.getText(StringsManager.name).toTitleCase()} *',
                              ...
                              CustomTextFormField(
                                ...
                                labelText:
                                    '${Methods.getText(StringsManager.confirmPassword).toTitleCase()} *',
                                prefixIconData: Icons.lock,
                                validator: (value) =>
                          ...
                          Wrap(
                            ...
                            children: [
                              Text(
                                Methods.getText(StringsManager
                                        .byClickingOnCreateAnAccountYouAgreeToThe)
                                    .toCapitalized(),
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                              ...
                              SizedBox(
                                ...
                                child: TextButton(
                                  onPressed: () => Methods.routeTo(
                                      context, Routes.termsOfUseScreen),
                                  style: TextButton.styleFrom(
                                    padding: EdgeInsets.zero,
                                  ),
                                  child: Text(
                                    Methods.getText(StringsManager.termsOfUse)
                                        .toUpperCase(),
                                    style:
                            ...
                            children: [
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                  ...
                                  minimumSize: Size(SizeManager.s200,
                                      36), // Set the width as specified
                                ),
                                onPressed: () {
                                  FocusScope.of(context).unfocus();
                                  provider.changeIsButtonClicked(true);
                                  if (_formKey.currentState!.validate() &&
                                      provider.isAllDataValid()) {
                                    RegisterAccountParameters
                                        registerAccountParameters =
                                        RegisterAccountParameters(
                                      mainCategoryId:
                                          provider.mainCategory!.mainCategoryId,
                                      fullName: _textEditingControllerFullName
                                          .text
                                          .trim(),
                                      personalImage: null,
                                      emailAddress:
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    color: Colors
                                        .white, // Assuming you want white text on the blue background
                                  ),
                                ),
                              ),
                              // CustomButton(
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  Methods.getText(StringsManager.login)
                                      .toUpperCase(),
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleSmall!
