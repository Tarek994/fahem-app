                            ...
                            CustomButton(
                              onPressed: () {
                                ...
                                if(_formKey.currentState!.validate()) {
                                  ResetUserPasswordParameters parameters = ResetUserPasswordParameters(
                                    emailAddress: widget.emailAddress,
                                    password: _textEditingControllerPassword.text,
                                  );
                                  MyProviders.authenticationProvider.resetPassword(context: context, resetUserPasswordParameters: parameters);
                                }
                              },
