...
import 'package:fahem_business/presentation/screens/jobs/widgets/extra_widget_in_top_jobs.dart';
import 'package:fahem_business/presentation/screens/jobs/widgets/job_grid_item.dart';
import 'package:fahem_business/presentation/screens/jobs/widgets/job_list_item.dart';
...
class _JobsScreenState extends State<JobsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance
        .addPostFrameCallback((_) async => await jobsProvider.fetchData());
  }

  void _onInsert(JobModel? job) {
    if (job != null) {
      jobsProvider.insertInJobs(job);
      if (jobsProvider.paginationModel != null)
        jobsProvider.paginationModel!.total++;
    }
  }
    ...
    return Consumer<JobsProvider>(
      builder: (context, provider, _) {
        return TemplateListScreen(
          ...
          goToInsertScreen:
              Methods.checkAdminPermission(AdminPermissions.addJob)
                  ? () {
                      Methods.routeTo(context, Routes.insertEditJobScreen,
                          arguments: null, then: (job) => _onInsert(job));
                    }
                  : null,
          title: _getTitle(),
          searchFilterOrderWidget: SearchFilterOrderWidget(
            ...
            ordersItems: const [
              OrderByType.jobsNewestFirst,
              OrderByType.jobsOldestFirst
            ],
