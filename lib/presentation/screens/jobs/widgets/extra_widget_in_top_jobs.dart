            ...
            children: [
              Expanded(
                child: CustomButton(
                  ...
                  buttonColor: jobsProvider.jobStatus == null
                      ? ColorsManager.veryDarkBlue
                      : ColorsManager.shadowblue,
                  textColor: jobsProvider.jobStatus == null
                      ? ColorsManager.white
                      : ColorsManager.veryDarkBlue,
              ...
              Expanded(
                child: CustomButton(
                  ...
                  width: double.infinity,
                  height: SizeManager.s35,
                  buttonColor: jobsProvider.jobStatus == JobStatus.active
                      ? ColorsManager.veryDarkBlue
                      : ColorsManager.shadowblue,
                  textColor: jobsProvider.jobStatus == null
                      ? ColorsManager.veryDarkBlue
              ...
              Expanded(
                child: CustomButton(
                  ...
                  width: double.infinity,
                  height: SizeManager.s35,
                  buttonColor: jobsProvider.jobStatus == JobStatus.pending
                      ? ColorsManager.veryDarkBlue
                      : ColorsManager.shadowblue,
                  textColor: jobsProvider.jobStatus == null
                      ? ColorsManager.veryDarkBlue
              ...
              Expanded(
                child: CustomButton(
                  ...
                  buttonType: ButtonType.text,
                  text:
                      Methods.getText(StringsManager.rejected).toCapitalized(),
                  width: double.infinity,
                  height: SizeManager.s35,
                  buttonColor: jobsProvider.jobStatus == JobStatus.rejected
                      ? ColorsManager.veryDarkBlue
                      : ColorsManager.shadowblue,
                  textColor: jobsProvider.jobStatus == null
                      ? ColorsManager.white
