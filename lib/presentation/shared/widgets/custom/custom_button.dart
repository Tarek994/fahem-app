...
class CustomButton extends StatelessWidget {
          ...
          shape: isCircleBorder
              ...
              : roundedRectangleBorder ??
                  RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                        color: isRequired ? ColorsManager.red700 : borderColor,
                        width: borderWidth),
                  ),
  ...
  Widget _getButton(BuildContext context) {
    switch (buttonType) {
      ...
      case ButtonType.image:
        return _imageButton(context);
      case ButtonType.preIcon:
        return _preIconButton(context);
      case ButtonType.postIcon:
        return _postIconButton(context);
      case ButtonType.preSpacerIcon:
        return _preSpacerIconButton(context);
      case ButtonType.postSpacerIcon:
        return _postSpacerIconButton(context);
      case ButtonType.preImage:
        return _preImageButton(context);
      case ButtonType.postImage:
        return _postImageButton(context);
      case ButtonType.preSpacerImage:
        return _preSpacerImageButton(context);
      case ButtonType.postSpacerImage:
        return _postSpacerImageButton(context);
      case ButtonType.postSpacerText:
        return _postSpacerTextButton(context);
      case ButtonType.preIconPostSpacerText:
        return _preIconPostSpacerTextButton(context);
      case ButtonType.preIconPostClickableIcon:
        return _preIconPostClickableIconButton(context);
      case ButtonType.prePersonalImageNetworkPostSpacer:
        return _prePersonalImageNetworkPostSpacerButton(context);
      default:
        return Container();
    }
  }
  ...
  Widget _imageButton(BuildContext context) {
    return Image.asset(imageName!,
        color: imageColor, width: imageSize, height: imageSize);
  }
