...
import 'package:fahem/presentation/shared/widgets/required_text_widget.dart';
...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    this.textFontWeight = FontWeightManager.semiBold,
    this.textHeight,
    this.iconData,
      ...
      children: [
        SizedBox(
          ...
          child: Padding(
            ...
            child: CircularProgressIndicator(color: ColorsManager.white, strokeWidth: SizeManager.s2),
          ),
        ),
      ],
    );
    ...
    return Row(
      ...
      children: [
        ...
        IconButton(
          ...
          icon: Icon(postClickableIconData, color: ColorsManager.lightPrimaryColor),
        ),
      ],
    );
  }
