...
class CustomTextFormField extends StatefulWidget {
  ...
  const CustomTextFormField({
    ...
    this.enabledBorderColor = ColorsManager.lightPrimaryColor,
    ...
    this.hintText,
    this.hintStyle,
    this.hintColor = ColorsManager.lightPrimaryColor,
    this.errorStyle,
    this.errorHeight,
    this.contentPadding,
    this.prefixIcon,
    ...
    this.prefixIconColor = ColorsManager.lightPrimaryColor,
    ...
    this.unFocusColor = ColorsManager.lightPrimaryColor,
    this.focusNode,
  });
    ...
    return Focus(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelStyle: widget.labelStyle ?? Theme.of(context).textTheme.displaySmall!.copyWith(color: hasFocus ? widget.labelColor : widget.unFocusColor, fontWeight: FontWeightManager.black),
          hintStyle: widget.hintStyle ?? Theme.of(context).textTheme.displaySmall!.copyWith(color: widget.hintColor, fontWeight: FontWeightManager.black),
