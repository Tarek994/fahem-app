...
class CustomTextFormField extends StatefulWidget {
  ...
  const CustomTextFormField({
    ...
    this.borderColor = ColorsManager.veryDarkBlue,
...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  _onFocusChange(hasFocus) {
    ...
    setState(() {
      if (hasFocus && widget.controller!.text.trim().isNotEmpty) {
        isShowClearIcon = true;
      } else {
        isShowClearIcon = false;
      }
  ...
  _onTapField() {
    ...
    if (widget.controller!.selection ==
        TextSelection.fromPosition(
            TextPosition(offset: widget.controller!.text.trim().length - 1))) {
      widget.controller!.selection = TextSelection.fromPosition(
          TextPosition(offset: widget.controller!.text.trim().length));
    }
  }
  ...
  OutlineInputBorder _getErrorBorder() {
    return OutlineInputBorder(
      borderRadius: BorderRadius.circular(widget.borderRadius),
      borderSide:
          BorderSide(color: widget.errorBorderColor, width: SizeManager.s1),
    );
  }
      ...
      return Material(
        ...
        child: IconButton(
          ...
          icon: Icon(Icons.clear,
              ...
              color: hasFocus ? widget.prefixIconColor : widget.unFocusColor),
        ),
      );
    }
  ...
  Widget? _getSuffixIcon() {
    ...
    if (widget.suffixIconData != null) {
      return Icon(widget.suffixIconData,
          size: widget.suffixIconSize, color: widget.suffixIconColor);
    }
    if (widget.suffixIcon != null) {
      return Row(
        ...
        children: [
          SizedBox(
            width:
                widget.suffixIconSize * 4.2, // Adjust this multiplier as needed
            height: widget.suffixIconSize * 1.5,
        ...
        decoration: InputDecoration(
          ...
          labelStyle: widget.labelStyle ??
              Theme.of(context).textTheme.displaySmall!.copyWith(
                  color: hasFocus ? widget.labelColor : widget.unFocusColor),
          ...
          errorStyle: widget.errorStyle ??
              Theme.of(context).textTheme.displaySmall!.copyWith(
                  color: ColorsManager.red700, height: widget.errorHeight),
          isDense: true,
