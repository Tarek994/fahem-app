...
class TemplateListScreen extends StatelessWidget {
  ...
  final Widget? flexibleSliverAppBar;
  final Color? appBarColor;
  final Color? scaffoldColor;
  final bool isSupportBack;
  final bool isSupportEmptyScreen;
        ...
        child: CustomFullLoading(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              if(flexibleSliverAppBar != null) flexibleSliverAppBar!,
              ...
              ConditionalBuilder(
                ...
                fallback: (_) => _FallbackWidget(
                  ...
                  isSupportEmptyScreen: isSupportEmptyScreen,
                ),
              ),
              if(isDataNotEmpty) SliverToBoxAdapter(
                child: Padding(
...
class _FallbackWidget extends StatelessWidget {
  ...
  const _FallbackWidget({
    ...
    required this.noDataMsgInScreen,
    required this.reFetchData,
    required this.isSupportEmptyScreen,
  });
