...
class TemplateListScreen extends StatelessWidget {
  ...
  Widget _showData() {
    if (supportedViewStyle.isEmpty)
      return const SliverToBoxAdapter(child: SizedBox());
    if (supportedViewStyle.contains(ViewStyle.list) &&
        currentViewStyle == ViewStyle.list &&
    ...
    if (supportedViewStyle.contains(ViewStyle.grid) &&
        currentViewStyle == ViewStyle.grid &&
  ...
  List<Widget>? _getAction(BuildContext context) {
      ...
      return [
        Padding(
          padding: const EdgeInsets.symmetric(
              horizontal: SizeManager.s16, vertical: SizeManager.s10),
    ...
    if (goToInsertScreen != null) {
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              Image.asset('assets/icons/fahemlogonoT.png'),
            ],
          ),
        ),
      ];
      ...
      Padding(
        padding: const EdgeInsets.symmetric(
            horizontal: SizeManager.s16, vertical: SizeManager.s10),
        child: Image.asset('assets/icons/fahemlogonoT.png'),
      );
    }
    return null;
  }
      ...
      body: CustomFullLoading(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            if (searchFilterOrderWidget != null &&
                !isSearchFilterOrderWidgetInAction)
              SliverToBoxAdapter(
                child: Container(
                  color: appBarColor,
                  padding:
                      const EdgeInsets.symmetric(horizontal: SizeManager.s16),
                  child: searchFilterOrderWidget!,
                ),
              ),
...
class _ViewStyleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(
          left: SizeManager.s16, right: SizeManager.s16, top: SizeManager.s8),
      child: Row(
        mainAxisAlignment: totalResults == null
        ...
        children: [
          ...
          if (supportedViewStyle.length == 2)
            Row(
              children: [
                IconButton(
                  onPressed: () {
                  ...
                  icon: Icon(
                    ...
                    color: viewStyle == ViewStyle.list
                ...
                IconButton(
                  ...
                  icon: Icon(
                    ...
                    size: SizeManager.s20,
                    color: viewStyle == ViewStyle.grid
                        ? ColorsManager.lightPrimaryColor
                        : ColorsManager.grey,
                  ),
                  visualDensity:
...
class _DefaultLastItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (hasMore) {
      ...
      return noDataMsgInLastItem == null
          ? const SizedBox()
          : Center(
              child: Padding(
                padding: const EdgeInsets.only(top: SizeManager.s10),
                child:
                    Text(Methods.getText(noDataMsgInLastItem!).toCapitalized()),
              ),
            );
    }
  }
