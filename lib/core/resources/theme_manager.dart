...
ThemeData _getApplicationThemeDark({required bool isEnglish}) {
  return ThemeData(
    ...
    // Text Theme
    textTheme: const TextTheme(
      titleSmall: TextStyle(color: ColorsManager.darkPrimaryColor, fontSize: SizeManager.s12, fontWeight: FontWeightManager.medium),
      titleMedium: TextStyle(color: ColorsManager.darkPrimaryColor, fontSize: SizeManager.s14, fontWeight: FontWeightManager.medium),
      titleLarge: TextStyle(color: ColorsManager.darkPrimaryColor, fontSize: SizeManager.s16, fontWeight: FontWeightManager.medium),

      bodySmall: TextStyle(color: ColorsManager.white, fontSize: SizeManager.s12, fontWeight: FontWeightManager.medium),
      bodyMedium: TextStyle(color: ColorsManager.white, fontSize: SizeManager.s14, fontWeight: FontWeightManager.medium),
      bodyLarge: TextStyle(color: ColorsManager.white, fontSize: SizeManager.s16, fontWeight: FontWeightManager.medium),
