...
import 'package:fahem/domain/usecases/accounts/edit_account_usecase.dart';
import 'package:fahem/domain/usecases/accounts/get_accounts_usecase.dart';
import 'package:fahem/domain/usecases/accounts/insert_account_usecase.dart';
import 'package:fahem/domain/usecases/admin_notifications/set_is_viewed_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/change_account_password_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/check_account_email_to_reset_password_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/delete_account_account_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/edit_account_profile_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/get_account_with_id_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/is_account_email_exist_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/is_account_exist_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/login_account_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/register_account_usecase.dart';
import 'package:fahem/domain/usecases/authentication_account/reset_account_password_usecase.dart';
...
import 'package:fahem/domain/usecases/features/edit_feature_usecase.dart';
import 'package:fahem/domain/usecases/features/get_feature_with_id_usecase.dart';
import 'package:fahem/domain/usecases/features/get_features_usecase.dart';
import 'package:fahem/domain/usecases/features/insert_feature_usecase.dart';
import 'package:fahem/domain/usecases/main_categories/delete_main_category_usecase.dart';
import 'package:fahem/domain/usecases/main_categories/edit_main_category_usecase.dart';
import 'package:fahem/domain/usecases/main_categories/get_main_categories_usecase.dart';
import 'package:fahem/domain/usecases/main_categories/get_main_category_with_id_usecase.dart';
import 'package:fahem/domain/usecases/main_categories/insert_main_category_usecase.dart';
import 'package:fahem/domain/usecases/playlists/delete_playlist_usecase.dart';
import 'package:fahem/domain/usecases/playlists/edit_playlist_usecase.dart';
import 'package:fahem/domain/usecases/playlists/get_playlist_with_id_usecase.dart';
import 'package:fahem/domain/usecases/playlists/get_playlists_usecase.dart';
import 'package:fahem/domain/usecases/playlists/insert_playlist_usecase.dart';
...
import 'package:fahem/domain/usecases/playlists_comments/get_playlist_comment_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/reviews/edit_review_usecase.dart';
import 'package:fahem/domain/usecases/reviews/get_review_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/services/delete_service_usecase.dart';
import 'package:fahem/domain/usecases/services/edit_service_usecase.dart';
import 'package:fahem/domain/usecases/services/get_service_with_id_usecase.dart';
import 'package:fahem/domain/usecases/services/get_services_usecase.dart';
import 'package:fahem/domain/usecases/services/insert_service_usecase.dart';
import 'package:fahem/domain/usecases/statistics/get_account_statistics_usecase.dart';
import 'package:fahem/domain/usecases/suggested_messages/delete_suggested_message_usecase.dart';
import 'package:fahem/domain/usecases/suggested_messages/edit_suggested_message_usecase.dart';
import 'package:fahem/domain/usecases/suggested_messages/get_suggested_message_with_id_usecase.dart';
import 'package:fahem/domain/usecases/suggested_messages/get_suggested_messages_usecase.dart';
...
import 'package:fahem/domain/usecases/videos/get_video_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/wallet_history/delete_wallet_history_usecase.dart';
import 'package:fahem/domain/usecases/wallet_history/edit_wallet_history_usecase.dart';
import 'package:fahem/domain/usecases/wallet_history/get_wallet_history_usecase.dart';
import 'package:fahem/domain/usecases/wallet_history/get_wallet_history_with_id_usecase.dart';
import 'package:fahem/domain/usecases/wallet_history/insert_wallet_history_usecase.dart';
import 'package:fahem/domain/usecases/withdrawal_requests/delete_withdrawal_request_usecase.dart';
import 'package:fahem/domain/usecases/withdrawal_requests/edit_withdrawal_request_usecase.dart';
import 'package:fahem/domain/usecases/withdrawal_requests/get_withdrawal_request_with_id_usecase.dart';
import 'package:fahem/domain/usecases/withdrawal_requests/get_withdrawal_requests_usecase.dart';
...
import 'package:fahem/domain/usecases/about_app/get_about_app_usecase.dart';
import 'package:fahem/domain/usecases/admins/delete_admin_usecase.dart';
import 'package:fahem/domain/usecases/admins/edit_admin_usecase.dart';
import 'package:fahem/domain/usecases/admins/get_admins_usecase.dart';
import 'package:fahem/domain/usecases/admins/insert_admin_usecase.dart';
import 'package:fahem/domain/usecases/articles/increment_article_views_usecase.dart';
...
import 'package:fahem/domain/usecases/authentication_admin/change_admin_password_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/check_admin_email_to_reset_password_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/delete_admin_account_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/edit_admin_profile_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/get_admin_with_id_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/is_admin_email_exist_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/is_admin_exist_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/login_admin_usecase.dart';
import 'package:fahem/domain/usecases/authentication_admin/reset_admin_password_usecase.dart';
import 'package:fahem/domain/usecases/categories/delete_category_usecase.dart';
import 'package:fahem/domain/usecases/categories/edit_category_usecase.dart';
import 'package:fahem/domain/usecases/categories/get_categories_usecase.dart';
import 'package:fahem/domain/usecases/categories/get_category_with_id_usecase.dart';
import 'package:fahem/domain/usecases/categories/insert_category_usecase.dart';
import 'package:fahem/domain/usecases/jobs/change_job_status_usecase.dart';
import 'package:fahem/domain/usecases/jobs/delete_job_usecase.dart';
import 'package:fahem/domain/usecases/jobs/edit_job_usecase.dart';
...
import 'package:fahem/domain/usecases/jobs/increment_job_views_usecase.dart';
import 'package:fahem/domain/usecases/jobs/insert_job_usecase.dart';
import 'package:fahem/domain/usecases/employment_applications/delete_employment_application_usecase.dart';
import 'package:fahem/domain/usecases/employment_applications/edit_employment_application_usecase.dart';
import 'package:fahem/domain/usecases/employment_applications/get_employment_applications_usecase.dart';
import 'package:fahem/domain/usecases/employment_applications/get_employment_application_with_id_usecase.dart';
import 'package:fahem/domain/usecases/employment_applications/insert_employment_application_usecase.dart';
import 'package:fahem/domain/usecases/complaints/delete_complaint_usecase.dart';
import 'package:fahem/domain/usecases/complaints/get_complaint_with_id_usecase.dart';
import 'package:fahem/domain/usecases/complaints/get_complaints_usecase.dart';
import 'package:fahem/domain/usecases/complaints/insert_complaint_usecase.dart';
import 'package:fahem/domain/usecases/faqs/delete_faq_usecase.dart';
import 'package:fahem/domain/usecases/faqs/edit_faq_usecase.dart';
import 'package:fahem/domain/usecases/faqs/get_faq_with_id_usecase.dart';
import 'package:fahem/domain/usecases/faqs/get_faqs_usecase.dart';
...
import 'package:fahem/domain/usecases/phone_number_requests/get_phone_number_request_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/booking_appointments/edit_booking_appointment_usecase.dart';
import 'package:fahem/domain/usecases/booking_appointments/get_booking_appointment_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/instant_consultations/delete_instant_consultation_usecase.dart';
import 'package:fahem/domain/usecases/instant_consultations/edit_instant_consultation_usecase.dart';
import 'package:fahem/domain/usecases/instant_consultations/get_instant_consultation_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/instant_consultations_comments/edit_instant_consultation_comment_usecase.dart';
import 'package:fahem/domain/usecases/instant_consultations_comments/get_instant_consultation_comment_with_id_usecase.dart';
import 'package:fahem/domain/usecases/instant_consultations_comments/get_instant_consultations_comments_usecase.dart';
import 'package:fahem/domain/usecases/instant_consultations_comments/insert_instant_consultation_comment_usecase.dart';
import 'package:fahem/domain/usecases/secret_consultations/delete_secret_consultation_usecase.dart';
import 'package:fahem/domain/usecases/secret_consultations/edit_secret_consultation_usecase.dart';
import 'package:fahem/domain/usecases/secret_consultations/get_secret_consultation_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/articles/get_article_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/notifications/get_notification_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/admin_notifications/delete_admin_notification_usecase.dart';
import 'package:fahem/domain/usecases/admin_notifications/get_admin_notification_with_id_usecase.dart';
import 'package:fahem/domain/usecases/admin_notifications/get_admin_notifications_usecase.dart';
...
import 'package:fahem/domain/usecases/service_description/edit_service_description_usecase.dart';
import 'package:fahem/domain/usecases/service_description/get_service_description_usecase.dart';
...
import 'package:fahem/domain/usecases/sliders/get_slider_with_id_usecase.dart';
...
import 'package:fahem/domain/usecases/social_media/get_social_media_with_id_usecase.dart';
import 'package:fahem/domain/usecases/social_media/insert_social_media_usecase.dart';
import 'package:fahem/domain/usecases/statistics/get_admin_statistics_usecase.dart';
import 'package:fahem/domain/usecases/terms_of_use/edit_terms_of_use_usecase.dart';
import 'package:fahem/domain/usecases/privacy_policy/get_privacy_policy_usecase.dart';
import 'package:fahem/domain/usecases/terms_of_use/get_terms_of_use_usecase.dart';
import 'package:fahem/domain/usecases/upload_file/upload_file_usecase.dart';
import 'package:fahem/domain/usecases/users/delete_user_usecase.dart';
...
class DependencyInjection {
  ...
  static void init() {
    ...
    getIt.registerLazySingleton<CheckUserExistWithPhoneNumberAndGetUseCase>(() => CheckUserExistWithPhoneNumberAndGetUseCase(getIt()));
    ...
    getIt.registerLazySingleton<GetAccountStatisticsUseCase>(() => GetAccountStatisticsUseCase(getIt()));
    // endregion
  ...
  static CheckUserExistWithPhoneNumberAndGetUseCase get checkUserExistWithPhoneNumberAndGetUseCase => getIt<CheckUserExistWithPhoneNumberAndGetUseCase>();
  ...
  static GetAccountStatisticsUseCase get getAccountStatisticsUseCase => getIt<GetAccountStatisticsUseCase>();
  // endregion
