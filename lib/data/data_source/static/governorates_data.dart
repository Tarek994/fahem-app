...
List<GovernorateModel> governoratesData = [
  ...
  const GovernorateModel(
    governorateId: 'qalyubiyya',
    governorateNameAr: 'القليوبية',
    governorateNameEn: 'Qalyubiyya',
  ),
  const GovernorateModel(
    governorateId: 'minya',
  ...
  const GovernorateModel(
    governorateId: 'monufia',
    governorateNameAr: 'المنوفية',
    governorateNameEn: 'Monufia',
  ),
  const GovernorateModel(
    governorateId: 'faiyum',
    governorateNameAr: 'الفيوم',
    governorateNameEn: 'Faiyum',
  ),
  const GovernorateModel(
    governorateId: 'kafrElSheikh',
    governorateNameAr: 'كفر الشيخ',
    governorateNameEn: 'Kafr El Sheikh',
  ),
  const GovernorateModel(
    governorateId: 'qena',
