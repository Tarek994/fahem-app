...
import 'package:fahem/core/helper/http_helper.dart';
...
abstract class BaseRemoteDataSource {
  ...
  Future<UserModel?> checkUserExistWithPhoneNumberAndGet(CheckUserExistWithPhoneNumberAndGetParameters parameters);
...
class RemoteDataSource extends BaseRemoteDataSource {
  ...
  Future<UserModel> registerUser(RegisterUserParameters parameters) async {
    Map<String, String> body = {
      ...
      ApiConstants.reasonForRegisteringField: parameters.reasonForRegistering.toString(),
  ...
  @override
  Future<UserModel?> checkUserExistWithPhoneNumberAndGet(CheckUserExistWithPhoneNumberAndGetParameters parameters) async {
    Map<String, String> body = {
      ApiConstants.phoneNumberField: parameters.phoneNumber.toString(),
    };
    var response = await HttpHelper.postData(
      endPoint: ApiConstants.checkUserExistWithPhoneNumberAndGetEndPoint,
      body: body,
      printErrorMessage: 'checkUserExistWithPhoneNumberAndGetError',
    );
    return response['user'] == null ? null : UserModel.fromJson(response['user']);
  }
  ...
  Future<InstantConsultationModel> insertInstantConsultation(InsertInstantConsultationParameters parameters) async {
    Map<String, String> body = {
      ...
      ApiConstants.bestInstantConsultationCommentIdField: parameters.bestInstantConsultationCommentId.toString(),
      ApiConstants.isViewedField: parameters.isViewed.toString(),
