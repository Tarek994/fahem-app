...
import 'package:fahem/data/data_source/static/appointment_booking_data.dart';
...
import 'package:fahem/data/models/static/appointment_booking_model.dart';
...
class AccountModel {
  ...
  // late final int numberOfUsersReviews;
  late final int numberOfReviewsExcellent;
  late final int numberOfReviewsGood;
  late final int numberOfReviewsLessThanExpected;
  ...
  AccountModel.fromJson(Map<String, dynamic> json) {
    ...
    // numberOfUsersReviews = int.parse(json['numberOfUsersReviews'].toString());
    numberOfReviewsExcellent = int.parse(json['numberOfReviewsExcellent'].toString());
    numberOfReviewsGood = int.parse(json['numberOfReviewsGood'].toString());
    numberOfReviewsLessThanExpected = int.parse(json['numberOfReviewsLessThanExpected'].toString());
